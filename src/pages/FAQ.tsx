...
const faqs = [
  ...
  { q: 'আপনারা কোন কোন পেমেন্ট পদ্ধতি গ্রহণ করেন?', a: 'দ্রুত ও নিরাপদ চেকআউটের জন্য আমরা সকল প্রধান ক্রেডিট কার্ড (Visa, Mastercard, Amex), PayPal এবং Apple Pay গ্রহণ করি।' },
...
export default function FAQ() {
  ...
  return (
    <>
      <PageHeader title="সচরাচর জিজ্ঞাসিত প্রশ্ন" subtitle="কেনাকাটা করার আগে আপনার যা জানা প্রয়োজন।" crumbs={[{ label: 'সচরাচর প্রশ্ন' }]} />
